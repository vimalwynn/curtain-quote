/*
  ...
  2. Security
    ...
    - All authenticated users can read and create products
    - Only users with associated quotations can update/delete products

  3. Indexes & Triggers
    - Add category index for faster lookups
